# -*- coding: utf-8 -*-
"""
Created on Mon Mar  2 22:16:31 2026
...
def init_db():
    ...
    CREATE TABLE IF NOT EXISTS events (
        ...
        product_id TEXT,   -- ID du produit si applicable
        query TEXT,        -- mot-clé de recherche si applicable
        event_data TEXT,   -- données JSON envoyées par Shopify ou par le front-end
...
def recommendations(customer_id):
    ...
    cursor.execute("""
        ...
        FROM events
        WHERE customer_id = ? AND event_type = 'click'
        GROUP BY product_id
